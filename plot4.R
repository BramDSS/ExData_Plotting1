...
##
## The script will create a png-plot called "plot4.png" and this plot
...
#sub plot 1:
plot(x = hopoco$Time, y = hopoco$Global_active_power,
     type = "l",
     xlab = "",
     ylab = "Global Active Power")

#sub plot 2:
plot(x = hopoco$Time, y = hopoco$Voltage,
     type = "l",
     xlab = "datetime",
     ylab = "Voltage")
...
#sub plot 4:
plot(x = hopoco$Time, y = hopoco$Global_reactive_power,
     type = "l",
     xlab = "datetime",
